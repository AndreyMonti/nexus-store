...
export default function SellerProfileScreen() {
  ...
  const handlePickAvatar = async () => {
    try {
      ...
      if (!hasPermission) {
        setAlert({ visible: true, title: 'Permissão necessária', message: 'Permita acesso à galeria de fotos', type: 'error' });
        return;
      }
      ...
      setAlert({ visible: true, title: 'Erro', message: (err as Error).message || 'Erro ao selecionar imagem', type: 'error' });
    }
  };
